...
+ (id)objectForJSON:(NSString *) inputJSON {
    NSDictionary *jDict = [NSJSONSerialization JSONObjectWithData:[inputJSON dataUsingEncoding:NSUTF8StringEncoding] options:0 error:nil];
...
- (NSString *)objectToJson {
	NSData *data = [NSJSONSerialization dataWithJSONObject:[self objectToDictionary] options:0 error:nil];
	if (data) {
